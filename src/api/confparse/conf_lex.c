...
YY_RULE_SETUP
#line 65 "conf_lex.l"
{/* identifier */ DEBUG_LEX("[bloc:%s]\n",yytext); strncpy(yylval.str_val,yytext,MAXSTRLEN); BEGIN BLOC; return IDENTIFIER;}
	YY_BREAK
case 2:
YY_RULE_SETUP
#line 68 "conf_lex.l"
{/* identifier */ DEBUG_LEX("BEGIN_BLOCK\n",yytext); BEGIN INBLOC;return BEGIN_BLOCK;}
	YY_BREAK
case 3:
YY_RULE_SETUP
#line 70 "conf_lex.l"
{/* identifier */ DEBUG_LEX("[id:%s",yytext);strncpy(yylval.str_val,yytext,MAXSTRLEN); BEGIN AFFECT;return IDENTIFIER;}
	YY_BREAK
case 4:
YY_RULE_SETUP
#line 71 "conf_lex.l"
{/* identifier */ DEBUG_LEX("END_BLOCK\n",yytext); BEGIN YY_INIT;return END_BLOCK;}
	YY_BREAK
case 5:
YY_RULE_SETUP
#line 73 "conf_lex.l"
{/* identifier */ DEBUG_LEX(" , ",yytext); BEGIN VALUE;return AFFECTATION;}
	YY_BREAK
case 6:
YY_RULE_SETUP
#line 75 "conf_lex.l"
...
YY_RULE_SETUP
#line 77 "conf_lex.l"
{/* valeur */DEBUG_LEX("value:%s",yytext);BEGIN ENDVALUE;strncpy(yylval.str_val,yytext,MAXSTRLEN); return KEYVALUE;}
	YY_BREAK
case 9:
YY_RULE_SETUP
#line 79 "conf_lex.l"
...
YY_RULE_SETUP
#line 82 "conf_lex.l"
{DEBUG_LEX(">");strncpy(yylval.str_val,YY_PARSED_STRING,MAXSTRLEN);BEGIN ENDVALUE;/* chaine finie */ return KEYVALUE;}
	YY_BREAK
case 12:
YY_RULE_SETUP
#line 83 "conf_lex.l"
